	...
	<div class="container">
		...
		<div class="col-md-12">
			...
			<div class="page-header">
				<h1><i class="fa fa-search" aria-hidden="true"></i> ძიება ვაგონის ნომრის ან ზედდებულის ნომრის მიხედვით</h1>
				<p id="big_p">
			    	<h5>PLEASE ENTER WANGON OR BILL NUMBER AND CLICK SUBMIT BUTTON</h5>
			    </p>
				<p id="small_p">
			    	<h5>გთხოვთ შეიყვანოთ ინვოისის ან ზედდებულის ნომერი და დააჭიროთ ღილაკს "დადასტურება"</h5>
			    </p>
			</div>
			...
			<div class="col-md-12" id="search_btns_wrp">
				<form action="" method="post">
					<div class="form-group">
						<label id="label">WAGON OR BILL NUMBER / ვაგონის ან ზედდებულის ნომერი</label>
...
<div class="col-md-12">
		<table class="table table-bordered" id="tbli">
			...
			<?php
				...
				$query4 = "SELECT * FROM bills WHERE wagon_number = '$numbera' OR bill_number = '$numbera'";
