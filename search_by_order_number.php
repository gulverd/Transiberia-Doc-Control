	...
	<div class="container">
		...
		<div class="col-md-12">
			...
			<div class="page-header">
				<h1><i class="fa fa-search" aria-hidden="true"></i> ძიება ოქმის ნომრის მიხედვით</h1>
				<p id="big_p">
			    	<h5>PLEASE ENTER ORDER NUMBER AND CLICK SUBMIT BUTTON</h5>
			    </p>
				<p id="small_p">
			    	<h5>გთხოვთ შეიყვანოთ ოქმის ნომერი და დააჭიროთ ღილაკს "დადასტურება"</h5>
			    </p>
			</div>
			...
			<div class="col-md-12" id="search_btns_wrp">
				<form action="" method="post">
					<div class="form-group">
						<label id="label">ORDER NUMBER / ოქმის ნომერი</label>
...
<div class="col-md-12">
		<table class="table table-bordered" id="tbli">
			...
			<?php
				...
				$order_numbera = $_POST['order_numbera'];
				

				$query3 = "SELECT *,a.id as id, b.client_name as order_owner_name FROM orders a JOIN clients b on a.order_owner = b.id  WHERE a.order_number = '$order_numbera' ORDER BY a.id DESC ";
