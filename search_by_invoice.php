	...
	<div class="container">
		...
		<div class="col-md-12">
			...
			<div class="page-header">
				<h1><i class="fa fa-search" aria-hidden="true"></i> ძიება ინვოისის ნომრის მიხედვით</h1>
				<p id="big_p">
			    	<h5>PLEASE ENTER INVOICE NUMBER AND CLICK SUBMIT BUTTON</h5>
			    </p>
				<p id="small_p">
			    	<h5>გთხოვთ შეიყვანოთ ინვოისის ნომერი და დააჭიროთ ღილაკს "დადასტურება"</h5>
			    </p>
			</div>
			...
			<div class="col-md-12" id="search_btns_wrp">
				<form action="" method="post">
					<div class="form-group">
						...
						<input type="text" name="invoice_numbera" class="form-control">
					</div>
					<div class="form-group">
...
<div class="col-md-12">
		<table class="table table-bordered" id="tbli">
			...
			<?php
				...
				$invoice_numbera = $_POST['invoice_numbera'];
				

				$query4 = "SELECT * FROM invoices WHERE invoice_code = '$invoice_numbera'";
