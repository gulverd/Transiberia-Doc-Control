	...
	<div class="container">
		...
		<div class="col-md-12">
			...
			<div class="page-header">
				<h1><i class="fa fa-search" aria-hidden="true"></i> ძიება გადაზიდვის კოდის მიხედვით</h1>
				<p id="big_p">
			    	<h5>PLEASE ENTER TRANSFER CODE AND CLICK SUBMIT BUTTON</h5>
			    </p>
				<p id="small_p">
			    	<h5>გთხოვთ შეიყვანოთ გადაზიდვის კოდი და დააჭიროთ ღილაკს "დადასტურება"</h5>
			    </p>
			</div>
			...
			<div class="col-md-12" id="search_btns_wrp">
				<form action="" method="post">
					<div class="form-group">
						<label id="label">TRANSFER CODE / გადაზიდვის კოდი</label>
						<input type="text" name="order_numbera" class="form-control">
					</div>
					<div class="form-group">
...
<div class="col-md-12">
		<table class="table table-bordered" id="tbli">
			...
			<?php
				...
				$invoice_numbera = $_POST['order_numbera'];
				

				$query4 = "SELECT * FROM order_codes WHERE code = '$invoice_numbera'";
				$run4   = mysqli_query($conn,$query4);

				while($row4 = mysqli_fetch_array($run4)){
					$order_ida = $row4['order_id'];

				$query3 = "SELECT *,a.id as id, b.client_name as order_owner_name FROM orders a JOIN clients b on a.order_owner = b.id  WHERE a.id = '$order_ida' ORDER BY a.id DESC ";
