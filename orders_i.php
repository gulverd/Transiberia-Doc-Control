...
<div class="container">
	...
	<div class="col-md-12">
		<table class="table table-bordered" id="tbli">
			...
			<?php
				$query2 = "SELECT *,a.id as id, b.client_name as order_owner_name FROM orders a JOIN clients b on a.order_owner = b.id WHERE a.order_status = '1' ORDER BY a.id DESC ";
